...
from src.DataAnalysis.Proficient.dianping_spider.parser import BASE_DIR
...
class SpiderDB:
    ...
    def save_shop_detail(self, detail):
        ...
        """,
            (
                ...
                (
                    json.dumps(detail.get("score_text"), ensure_ascii=False)
                    if detail.get("score_text")
                    else None
                ),
                detail.get("price"),
                detail.get("region"),
    ...
    def set_progress(self, value, key="last_page"):
        ...
        cur = self.conn.cursor()
        cur.execute(
            "INSERT INTO progress(key_name, value) VALUES (?, ?) ON CONFLICT(key_name) DO UPDATE SET value=excluded.value;",
            (key, str(value)),
        )
        self.conn.commit()
    ...
    def get_progress(self, key="last_page"):
        ...
        row = self.conn.execute(
            "SELECT value FROM progress WHERE key_name=?", (key,)
        ).fetchone()
...
def test_db_operations():
    ...
    sample_shops = [
        {
            "data_shopid": "G9B5lBAWimhGRPnh",
            "shop_name": "北京宜宾招待所(南翠花街店)",
            "recommend_dishes": "红糖冰粉, 粉蒸肉, 宜宾燃抄手",
            "shop_link": "https://www.dianping.com/shop/G9B5lBAWimhGRPnh",
        },
        {
            "data_shopid": "l5jXXDwnM5PbZB93",
            "shop_name": "百花人家(门城水岸店)",
            "recommend_dishes": "火盆石磨豆腐, 烤羊肉串, 大厨功夫鱼",
            "shop_link": "https://www.dianping.com/shop/l5jXXDwnM5PbZB93",
        },
        {
            "data_shopid": "H3SyNUSShP5BYm87",
            "shop_name": "逗思都吃韩国料理(五道口店)",
            "recommend_dishes": "自制金枪鱼饭团, 奶酪辣鸡, 部队火锅",
            "shop_link": "https://www.dianping.com/shop/H3SyNUSShP5BYm87",
        },
        {
            "data_shopid": "k6ASsfEU2GWeDmTk",
            "shop_name": "浩海火烧云傣家菜(京广店)",
            "recommend_dishes": "油焖鸡, 黑三剁, 小锅米线",
            "shop_link": "https://www.dianping.com/shop/k6ASsfEU2GWeDmTk",
        },
        {
            "data_shopid": "l7TjgjzVZS6j8830",
            "shop_name": "南门涮肉(国贸商城店)",
            "recommend_dishes": "麻酱小料, 自制烧饼, 鲜羊肉",
            "shop_link": "https://www.dianping.com/shop/l7TjgjzVZS6j8830",
        },
        {
            "data_shopid": "l4RMiRJoi6FBJ4v4",
            "shop_name": "铃木食堂(杨梅竹店)",
            "recommend_dishes": "日式牛肉火锅, 杏仁豆腐, 铃木肉饼",
            "shop_link": "https://www.dianping.com/shop/l4RMiRJoi6FBJ4v4",
        },
        {
            "data_shopid": "l3AK2xTtKoddz7SD",
            "shop_name": "四季民福烤鸭店(东四十条店)",
            "recommend_dishes": "酥香嫩烤鸭, 贝勒烤肉, 巧拌豆苗",
            "shop_link": "https://www.dianping.com/shop/l3AK2xTtKoddz7SD",
        },
        {
            "data_shopid": "j6rTOedDbGNsLVFd",
            "shop_name": "Bada kitchen 和风洋食(中关村店)",
            "recommend_dishes": "嫩滑蛋包咖喱饭, 猪肉奶酪紫苏卷, 奶酪厚蛋烧",
            "shop_link": "https://www.dianping.com/shop/j6rTOedDbGNsLVFd",
        },
        {
            "data_shopid": "kaXGb95W714S3AK8",
            "shop_name": "九本居酒屋(亚运村店)",
            "recommend_dishes": "厚切三文鱼, 极上炭烤鳗鱼, 海胆酱焗牛油梨",
            "shop_link": "https://www.dianping.com/shop/kaXGb95W714S3AK8",
        },
        {
            "data_shopid": "G9VwkrHORDQkQMpr",
            "shop_name": "胖妹面庄(香饵胡同店)",
            "recommend_dishes": "豌杂面, 狼牙土豆, 经典混合面",
            "shop_link": "https://www.dianping.com/shop/G9VwkrHORDQkQMpr",
        },
        {
            "data_shopid": "G3ZxMJTDLITGsxLX",
            "shop_name": "南门涮肉(东单店)",
            "recommend_dishes": "小料双拼, 自制烧饼, 糖蒜",
            "shop_link": "https://www.dianping.com/shop/G3ZxMJTDLITGsxLX",
        },
        {
            "data_shopid": "FUs9OoiuF7Ey68y1",
            "shop_name": "福和小馆(顺义店)",
            "recommend_dishes": "侉炖千岛湖鱼头泡饼, 薄脆锅贴, 乾隆白菜",
            "shop_link": "https://www.dianping.com/shop/FUs9OoiuF7Ey68y1",
        },
        {
            "data_shopid": "FPcwD2D5x1QfVFoQ",
            "shop_name": "金悦•梦华录(金融街购物中心店)",
            "recommend_dishes": "家嫂姜葱熘牛展, 鲜虾龙皇饺, 铁镬脆皮蚝仔烙煎",
            "shop_link": "https://www.dianping.com/shop/FPcwD2D5x1QfVFoQ",
        },
        {
            "data_shopid": "G5leUTaSm4qGOalp",
            "shop_name": "淮扬府(安定门店)",
            "recommend_dishes": "招牌茨菇红烧肉, 响油鳝糊, 淮扬鸡汤大煮干丝",
            "shop_link": "https://www.dianping.com/shop/G5leUTaSm4qGOalp",
        },
        {
            "data_shopid": "G42raZgZrwxB69Oj",
            "shop_name": "京兆尹(雍和宫店)",
            "recommend_dishes": "糖醋藕排, 金刚沙豆腐, 桃胶珍菌卤味饭",
            "shop_link": "https://www.dianping.com/shop/G42raZgZrwxB69Oj",
        },
    ]
    ...
    sample_detail = {
        ...
        "shop_name": "百花人家(门城水岸店)",
        "star_score": "4.7",
        "score_text": "口味:4.7 环境:4.7 服务:4.7",
        "price": "¥93/人",
        "region": "门头沟城区",
        "category": "农家菜",
        "desc_addr_txt": "",
        "address": "西六环与永堤西路交叉口南100米路东",
        "reviews": 14901,
        "biz_time": "11:00开始营业",
    }
